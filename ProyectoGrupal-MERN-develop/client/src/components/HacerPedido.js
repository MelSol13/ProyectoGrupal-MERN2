...
const HacerPedido = () => {
    ...
    return (
        <div className='container'>
            ...
            <div>
                <Link className="btn-cambios" to={"/editarpedido/" + pedido._id}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
