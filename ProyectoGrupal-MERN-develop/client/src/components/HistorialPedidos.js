    ...
    return (
        <div>
            ...
            <nav className='nav-historial'>
                ...
                <Link to="/hacerpedido" className="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <tbody>
                    {
                        pedidos.map((pedido, index) => (
                            <tr key={index}>
                                ...
                                <td>{pedido.fecha}</td>
                                <td>{pedido.hora}</td>
                                <td><img className="img-historial" src={pedido.imagen} /></td>
                                <td>
                                    <Link to={`/editarpedido/${pedido._id}`} className="btn btn-warning"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-pencil-fill" viewBox="0 0 16 16">
