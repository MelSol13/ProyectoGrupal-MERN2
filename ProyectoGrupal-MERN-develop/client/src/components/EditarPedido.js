            ...
            <div className='row'>
                <form className='form' onSubmit={editarPedido}>
                    <div className='col-md-4'>
                        ...
                        <button type="submit" className="btn-vista2" onClick={editarPedido}><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
