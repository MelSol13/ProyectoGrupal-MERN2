            ...
            <div className="row">
                ...
                <form className="form-2" onSubmit={actualizarSitio}>
                    ...
                    <div className="col-md-4">
                        ...
                        <div>
                            <button type="submit" className="btn-vista3" onClick={actualizarSitio}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
